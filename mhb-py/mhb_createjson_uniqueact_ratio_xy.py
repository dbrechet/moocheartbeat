...
datafilename = 'mhb-data/uniqueact_ratio_xy.json'
...
jsfilename ='mhb-js/uniqueact_ratio_xy.js'
jsmessage = """
...
htmlfilename = 'test-uniqueact_ratio_xy.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="mhb-js/uniqueact_ratio_xy.js"></script>
