...
for row_session in rows_session:
    ...
    datafilename = 'mhb-data/14_onecourse_'+data_session+'_uniqueregsum_activity_xy.json'
    ...
    # create the js file.
    jsfilename ='mhb-js/14_onecourse_'+data_session+'_uniqueregsum_activity_xy.js'
    jsmessage = """
        var data = d3.json("mhb-data/14_onecourse_"""+data_session+"""_uniqueregsum_activity_xy.json", function(error, data){
    ...
    htmlfilename = '14_test-onecourse_'+data_session+'_uniqueregsum_activity_xy.html'
    htmlmessage = """
    <!DOCTYPE html>
    <html>
	   <head>
            ...
            <script type="text/javascript" src="mhb-js/14_onecourse_"""+data_session+"""_uniqueregsum_activity_xy.js"></script>
