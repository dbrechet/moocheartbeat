...
for row_session in rows_session:
    ...
    columns.append(data_session + '_actrel')
    columns.append(data_session + '_mooc')
...
datafilename = 'mhb-data/15_uniqueregsum_activity_xy.json'
...
jsfilename ='mhb-js/15_uniqueregsum_activity_xy.js'
jsmessage = """
    var data = d3.json("mhb-data/15_uniqueregsum_activity_xy.json", function(error, data){
...
htmlfilename = '15_test-uniqueregsum_activity_xy.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        <title>Iter 06: 15, uniqueregsum_activity_xy| amCharts</title>
        ...
        <script type="text/javascript" src="mhb-js/15_uniqueregsum_activity_xy.js"></script>
