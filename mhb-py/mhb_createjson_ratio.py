...
with io.open('../mhb-data/courses-ratio.json', 'w', encoding='utf-8') as f:
    f.write(unicode(json.dumps(data_dict, sort_keys=True, indent=4, separators=(',', ': '), ensure_ascii=False)))

jsfilename ='../mhb-js/courses-ratio.js'
jsmessage = """
...
htmlfilename = '../test-courses-ratio.html'
htmlmessage = """
    <!DOCTYPE html>
    <html>
	   <head>
            ...
            <script type="text/javascript" src="mhb-js/courses-ratio.js"></script>
