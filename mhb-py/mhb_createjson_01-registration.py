#!/usr/bin/env python
#title           :mhb_createjson_registration.py
#description     :This will make a query to the database and create a json file to store the data. The data is registration.
#author          :dbrechet
#date            :20141014
#version         :0.1
#usage           :python mhb_createjson_registration.py
#notes           :
...
for row in rows:
    ...
    sql_session = "SELECT session, registrations FROM mhb_coursera WHERE item = '" + data_item + "' ORDER BY session ASC"
...
item_va_value.append("Registration")
...
htmlfilename = '01_registration.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="mhb-js/01_registration.js"></script>
