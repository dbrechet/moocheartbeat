#!/usr/bin/env python
#title           :mhb_createjson_onecourse_unique.py
...
#date            :20141014
#version         :0.1
#usage           :python mhb_createjson_onecourse_unique.py
#notes           :
...
for row_session in rows_session:
    ...
    datafilename = 'mhb-data/02_onecourse_'+data_session+'_unique.json'
    ...
    jsfilename ='mhb-js/02_onecourse_'+data_session+'_unique.js'
    jsmessage = """
        var data = d3.json("mhb-data/02_onecourse_"""+data_session+"""_unique.json", function(error, data){
        var chart = AmCharts.makeChart("chartdiv", data);
        });"""
    with io.open(jsfilename, 'w', encoding='utf-8') as fj:
        fj.write(unicode(jsmessage))
    htmlfilename = '02_test-onecourse_'+data_session+'_unique.html'
    htmlmessage = """
    <!DOCTYPE html>
    <html>
	   <head>
            ...
            <script type="text/javascript" src="mhb-js/02_onecourse_"""+data_session+"""_unique.js"></script>
