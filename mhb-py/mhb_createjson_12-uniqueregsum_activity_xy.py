...
datafilename = 'mhb-data/12_uniqueregsum_activity_xy.json'
...
jsfilename ='mhb-js/12_uniqueregsum_activity_xy.js'
jsmessage = """
    var data = d3.json("mhb-data/12_uniqueregsum_activity_xy.json", function(error, data){
...
htmlfilename = '12_test-uniqueregsum_activity_xy.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        <title>Iter 06: 12, uniqueregsum_activity_xy| amCharts</title>
        ...
        <script type="text/javascript" src="mhb-js/12_uniqueregsum_activity_xy.js"></script>
