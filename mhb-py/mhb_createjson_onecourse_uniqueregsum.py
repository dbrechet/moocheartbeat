...
for row_session in rows_session:
    ...
    datafilename = '../mhb-data/onecourse_'+data_session+'_uniqueregsum.json'
    ...
    jsfilename ='../mhb-js/onecourse_'+data_session+'_uniqueregsum.js'
    jsmessage = """
        var data = d3.json("../mhb-data/onecourse_"""+data_session+"""_uniqueregsum.json", function(error, data){
        var chart = AmCharts.makeChart("chartdiv", data);
        });"""
    with io.open(jsfilename, 'w', encoding='utf-8') as fj:
        fj.write(unicode(jsmessage))
    htmlfilename = '../test-onecourse_'+data_session+'_uniqueregsum.html'
    htmlmessage = """
    <!DOCTYPE html>
    <html>
	   <head>
            <title>uniqueregsum """+data_session+""" | amCharts</title>
            ...
            <script type="text/javascript" src="mhb-js/onecourse_"""+data_session+"""_uniqueregsum.js"></script>
