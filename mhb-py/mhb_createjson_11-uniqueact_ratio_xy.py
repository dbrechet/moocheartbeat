#!/usr/bin/env python
#title           :mhb_createjson_onecourse_uniqueact_ratio_xy.py
...
#date            :20141014
#version         :0.1
#usage           :python mhb_createjson_onecourse_uniqueact_ratio_xy.py
#notes           :
...
for row_session in rows_session:
    ...
    item_graph_value.append(columns_n[2])
...
datafilename = 'mhb-data/11_uniqueact_ratio_xy.json'
...
jsfilename ='mhb-js/11_uniqueact_ratio_xy.js'
jsmessage = """
...
htmlfilename = '11_test-uniqueact_ratio_xy.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="mhb-js/11_uniqueact_ratio_xy.js"></script>
