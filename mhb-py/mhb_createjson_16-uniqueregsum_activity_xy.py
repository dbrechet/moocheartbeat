...
for row_session in rows_session:
    ...
    sql_item = """SELECT item, registrations, assignment_unique + forum_comment_unique + forum_post_unique + 
                      ...
                      quiz_quiz_unique + quiz_survey_unique + quiz_video_unique as activity
                      FROM mhb_coursera 
                      WHERE session='"""+data_session+"' ORDER BY item ASC"
...
datafilename = 'mhb-data/16_uniqueregsum_activity_xy.json'
...
jsfilename ='mhb-js/16_uniqueregsum_activity_xy.js'
jsmessage = """
    var data = d3.json("mhb-data/16_uniqueregsum_activity_xy.json", function(error, data){
...
htmlfilename = '16_test-uniqueregsum_activity_xy.html'
htmlmessage = """
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="mhb-js/16_uniqueregsum_activity_xy.js"></script>
